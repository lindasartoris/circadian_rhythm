...
#Linda Sartoris: small modification to adjust for different volume of fungal spore suspension
...
high_threshold <- 0.0411 * 0.5/0.3 # LS: was adjusted because we (AW & I) use only 0.3 µl instead of 0.5 µl of fungal spore suspension 
